 ...
 *
 *
 *  Versão 1.0.3 - 18/02/2015
 *  - inputMoney podendo receber via html o número de casas decimais desejados
 *
    ...
    return {
        ...
        link: function ($scope, elem, attrs, ctrl) {
            ...
            ctrl.$formatters.unshift(function (a) {
                ...
                if(attrs.inputMoney){
                    try{
                        fractionSize = parseInt(attrs.inputMoney);
                    }catch(ex){ }
                }
				return $filter("currency")(ctrl.$modelValue, '', fractionSize);
            });
