...
/*.factory('$menu',function(){
    return {
        ...
        CARD_SERVICES : {
            CONSOLIDACAO : {
                RELATORIO_SINTETICO : 101,
                RELATORIO_ANALITICO : 102
                // . . .
            },
            CONCILIACAO : {
                CONCILIACAO_VENDAS : 103
            }
        },
        TAX_SERVICES : {
            OP1_TS : {
        ...
        ADMINISTRATIVO : {
          ATOS_CAPITAL : {
              ADMINISTRADOR : 150, // acesso a toda parte administrativa
              FINANCEIRO : 151 // somente a parte financeira
              // ....
          },
          EMPRESA : 180 // pode ser dividido
        },

        // A partir do valor, obtem o nome amigável    
        getName : function(value){
            switch(value){
                case this.DASHBOARD : return 'Dashboard';
                // Card Services
                case this.CARD_SERVICES.CONSOLIDACAO.RELATORIO_SINTETICO : return 'Relatório Sintético';
                case this.CARD_SERVICES.CONSOLIDACAO.RELATORIO_ANALITICO : return 'Relatório Analítico';
                case this.CARD_SERVICES.CONCILIACAO.CONCILIACAO_VENDAS : return 'Conciliação de Vendas';
                // Tax Services
                case this.TAX_SERVICES.OP1_TS.OP1 : return 'Op1';
                case this.TAX_SERVICES.OP2_TS.OP2 : return 'Op2';
                case this.TAX_SERVICES.OP2_TS.OP3 : return 'Op3';
                case this.TAX_SERVICES.OP3_TS.OP4 : return 'Op4';
                case this.TAX_SERVICES.OP3_TS.OP5 : return 'Op5';
                // ProInfo
                case this.PROINFO.OP1_PI.OP1 : return 'Op1';
                case this.PROINFO.OP1_PI.OP2 : return 'Op2';
                case this.PROINFO.OP2_PI.OP3 : return 'Op3';
                case this.PROINFO.OP2_PI.OP4 : return 'Op4';
