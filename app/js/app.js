 ...
 *
 *  Versão 1.1.6 - 04/01/2016
 *  - ajuste em getDataFromDate()
 *
 ...
 *  - AngularPrint
 *  - $scope.print()
 *  - card-services-conciliacao-titulos
 *
 *  Versão 1.0.9 - 06/11/2015
 *  - administrativo-consulta-parametros
 *
...
.config(['$stateProvider','$urlRouterProvider','$locationProvider', '$httpProvider',
    ...
    $stateProvider
      ...
      .state('administrativo-gestao-acessos-consulta-parametros', {
        url: prefixo + 'administrativo/consulta-parametros',
        templateUrl: 'componentes/administrativo/gestao-acessos/consulta-parametros/index.html',
        controller: "administrativo-consulta-parametrosCtrl",
        data: {
            titulo: 'Administrativo'
        }
      })
      ...
      // CARD SERVICES
      .state('card-services-antecipacao-bancaria', {
      ...
      .state('card-services-cash-flow-recebiveis-futuros', {
        url: prefixo + 'card-services/recebiveis-futuros',
        templateUrl: 'componentes/card-services/cash-flow/recebiveis-futuros/index.html',
        controller: "card-services-recebiveis-futurosCtrl",
        data: {
            titulo: 'Card Services'
        }
      })
      ...
      .state('card-services-conciliacao-conciliacao-titulos', {
        url: prefixo + 'card-services/conciliacao-titulos',
        templateUrl: 'componentes/card-services/conciliacao/conciliacao-titulos/index.html',
        controller: "card-services-conciliacao-titulosCtrl",
        data: {
            titulo: 'Card Services'
        } 
      }) 
    
      .state('card-services-conciliacao-relatorio-conciliacao-titulos', {
        url: prefixo + 'card-services/relatorio-conciliacao-titulos',
        templateUrl: 'componentes/card-services/conciliacao/relatorio-conciliacao-titulos/index.html',
        controller: "card-services-relatorio-conciliacao-titulosCtrl",
        data: {
            titulo: 'Card Services'
        } 
      })
    ...
    .state('card-services-consolidacao-movimento-tef', {
        ...
        controller: "card-services-movimento-tefCtrl",
        data: {
            titulo: 'Card Services'
        }
      })
      ...
      // NOTÍCIAS
      .state('noticias', {
        url: prefixo + 'noticias',
        templateUrl: 'componentes/noticias/index.html',
...
.controller("appCtrl", ['$scope',
    ...
    var controllerAdministrativoConsultaParametros = undefined;                        
    ...
    var controllerCardServicesConciliacaoTitulos = undefined;        
    var controllerCardServicesRelatorioConciliacaoTitulos = undefined;                        
    ...
    var controllerCardServicesMovimentoTef = undefined;
    ...
    var controllerNoticias = undefined;                        
    ...
    $scope.PERMISSAO_ADMINISTRATIVO_GESTAO_DE_ACESSOS_CONSULTA_PARAMETROS = false;                        
    ...
    $scope.PERMISSAO_CARD_SERVICES_CONCILIACAO_CONCILIACAO_TITULOS = false;
    $scope.PERMISSAO_CARD_SERVICES_CONCILIACAO_RELATORIO_CONCILIACAO_TITULOS = false;                        
    ...
    $scope.PERMISSAO_NOTICIAS = false;                        
    ...
    /**
      * Exibe como conteúdo a Gestão de Acessos Consulta Parâmetros, de Administrativo
      */
    $scope.goAdministrativoConsultaParametros = function(params){
        controllerAtual = controllerAdministrativoConsultaParametros;
        go('administrativo-gestao-acessos-consulta-parametros', params);
    };                        
    /**
    ...
    /**
      * Exibe como conteúdo a Antecipação Bancária Antecipação, de Card Services
      */
    ...
    /**
      * Exibe como conteúdo a Cash Flow Relatório de Vendas, de Card Services
      */
    ...
    /**
      * Exibe como conteúdo a Cash Flow Recebíveis Futuros, de Card Services
      */
    ...
    /**
      * Exibe como conteúdo a Conciliação Conciliação de Títulos, de Card Services
      */
    $scope.goCardServicesConciliacaoTitulos = function(params){
        controllerAtual = controllerCardServicesConciliacaoTitulos;
        go('card-services-conciliacao-conciliacao-titulos', params);
    };
    /**
      * Exibe como conteúdo a Conciliação Relatório de Conciliação de Títulos, de Card Services
      */
    $scope.goCardServicesRelatorioConciliacaoTitulos = function(params){
        controllerAtual = controllerCardServicesRelatorioConciliacaoTitulos;
        go('card-services-conciliacao-relatorio-conciliacao-titulos', params);
    };                          
    /**
    ...
    /**
      * Exibe como conteúdo o Notícias
      */
    $scope.goNoticias = function(params){
        controllerAtual = controllerNoticias;
        go('noticias', params);
    };                        
    /**
    ...
    $rootScope.$on("$locationChangeStart", function(event, next, current){
        ...
        if(url === $state.get('administrativo-gestao-acessos-usuarios').url ||
           url === $state.get('administrativo-gestao-acessos-usuarios-cadastro').url){
            ...
            // Administrativo > Gestão de Acesso > Privilégios
            if(!$scope.PERMISSAO_ADMINISTRATIVO || !$scope.PERMISSAO_ADMINISTRATIVO_GESTAO_DE_ACESSOS || !$scope.PERMISSAO_ADMINISTRATIVO_GESTAO_DE_ACESSOS_PRIVILEGIOS){
                ...
                $scope.reloadPage(); // recarrega a página para forçar a associação do controllerAtual
        }else if(url === $state.get('administrativo-gestao-acessos-consulta-parametros').url){
            // Administrativo > Gestão de Acesso > Consulta Parâmetros
            if(!$scope.PERMISSAO_ADMINISTRATIVO || !$scope.PERMISSAO_ADMINISTRATIVO_GESTAO_DE_ACESSOS || !$scope.PERMISSAO_ADMINISTRATIVO_GESTAO_DE_ACESSOS_CONSULTA_PARAMETROS){
                // Não possui permissão!
                event.preventDefault();
                $scope.goUsuarioSemPrivilegios();
            }else if(!controllerAtual || //controllerAtual.ds_controller.toUpperCase() !== 'CONSULTA PARÂMETROS')
                     controllerAtual.id_controller !== controllerAdministrativoConsultaParametros.id_controller)
                $scope.reloadPage(); // recarrega a página para forçar a associação do controllerAtual
        }else if(url === $state.get('administrativo-gestao-acessos-modulos-funcionalidades').url){
            // Administrativo > Gestão de Acesso > Módulos e Funcionalidades
            ...
            if(!$scope.PERMISSAO_DASHBOARD){
                ...
                $scope.reloadPage(); // recarrega a página para forçar a associação do controllerAtual
        }else if(url === $state.get('card-services-antecipacao-bancaria').url){
            // Card Services > Antecipação > Antecipação Bancária
            if(!$scope.PERMISSAO_CARD_SERVICES || !$scope.PERMISSAO_CARD_SERVICES_ANTECIPACAO || !$scope.PERMISSAO_CARD_SERVICES_ANTECIPACAO_ANTECIPACAO_BANCARIA){
                // Não possui permissão!
                event.preventDefault();
                $scope.goUsuarioSemPrivilegios();
            ...
            if(!$scope.PERMISSAO_CARD_SERVICES || !$scope.PERMISSAO_CARD_SERVICES_CASH_FLOW || !$scope.PERMISSAO_CARD_SERVICES_CASH_FLOW_RELATORIO_VENDAS){
                ...
                $scope.reloadPage(); // recarrega a página para forçar a associação do controllerAtual
        }else if(url === $state.get('card-services-cash-flow-recebiveis-futuros').url){
            // Card Services > Cash Flow > Recebíveis Futuros
            if(!$scope.PERMISSAO_CARD_SERVICES || !$scope.PERMISSAO_CARD_SERVICES_CASH_FLOW || !$scope.PERMISSAO_CARD_SERVICES_CASH_FLOW_RECEBIVEIS_FUTUROS){
                // Não possui permissão!
                event.preventDefault();
                $scope.goUsuarioSemPrivilegios();
            ...
            if(!$scope.PERMISSAO_CARD_SERVICES || !$scope.PERMISSAO_CARD_SERVICES_CONCILIACAO || !$scope.PERMISSAO_CARD_SERVICES_CONCILIACAO_CONCILIACAO_BANCARIA){
                ...
                $scope.reloadPage(); // recarrega a página para forçar a associação do controllerAtual
        }else if(url === $state.get('card-services-conciliacao-conciliacao-titulos').url){
            // Card Services > Conciliação > Conciliação de Títulos
            if(!$scope.PERMISSAO_CARD_SERVICES || !$scope.PERMISSAO_CARD_SERVICES_CONCILIACAO || !$scope.PERMISSAO_CARD_SERVICES_CONCILIACAO_CONCILIACAO_TITULOS){
                // Não possui permissão!
                event.preventDefault();
                $scope.goUsuarioSemPrivilegios();
            }else if(!controllerAtual || //controllerAtual.ds_controller.toUpperCase() !== 'CONCILIAÇÃO DE TÍTULOS')
                     controllerAtual.id_controller !== controllerCardServicesConciliacaoTitulos.id_controller)
                $scope.reloadPage(); // recarrega a página para forçar a associação do controllerAtual
        }else if(url === $state.get('card-services-conciliacao-relatorio-conciliacao-titulos').url){
            // Card Services > Conciliação > Relatório de Conciliação de Títulos
            if(!$scope.PERMISSAO_CARD_SERVICES || !$scope.PERMISSAO_CARD_SERVICES_CONCILIACAO || !$scope.PERMISSAO_CARD_SERVICES_CONCILIACAO_RELATORIO_CONCILIACAO_TITULOS){
                // Não possui permissão!
                event.preventDefault();
                $scope.goUsuarioSemPrivilegios();
            }else if(!controllerAtual || //controllerAtual.ds_controller.toUpperCase() !== 'RELATÓRIO DE CONCILIAÇÃO DE TÍTULOS')
                     controllerAtual.id_controller !== controllerCardServicesRelatorioConciliacaoTitulos.id_controller)
                $scope.reloadPage(); // recarrega a página para forçar a associação do controllerAtual
            ...
            if(!$scope.PERMISSAO_CARD_SERVICES || !$scope.PERMISSAO_CARD_SERVICES_TEF || !$scope.PERMISSAO_CARD_SERVICES_TEF_RESUMO_DE_MOVIMENTO){
                ...
                $scope.reloadPage(); // recarrega a página para forçar a associação do controllerAtual
        }*/else if(url === $state.get('noticias').url){
            // Notícias
            if(!$scope.PERMISSAO_NOTICIAS){
                // Não possui permissão!
                event.preventDefault();
                $scope.goUsuarioSemPrivilegios();
            }else if(!controllerAtual || //controllerAtual.ds_controller.toUpperCase() !== 'NOTÍCIAS')
                     controllerAtual.id_controller !== controllerNoticias.id_controller)
                $scope.reloadPage(); // recarrega a página para forçar a associação do controllerAtual
    ...
    var getLink = function(controller, controllerpai){
        switch(controller.ds_controller.toUpperCase()){
            ...
            case 'CONSULTA PARÂMETROS' :
                if($location.path() === $state.get('administrativo-gestao-acessos-consulta-parametros').url)
                    controllerAtual = controller;
                controllerAdministrativoConsultaParametros = controller;
                return $scope.goAdministrativoConsultaParametros;    
            ...
            // Notícias
            case 'NOTÍCIAS':
                if($location.path() === $state.get('noticias').url) controllerAtual = controller;
                controllerNoticias = controller;
                return $scope.goNoticias;    
            // Card Services
            case 'ANTECIPAÇÃO BANCÁRIA':
            ...
            case 'RECEBÍVEIS FUTUROS': 
                if($location.path() === $state.get('card-services-cash-flow-recebiveis-futuros').url)
                    controllerAtual = controller;
            ...
            case 'CONCILIAÇÃO DE TÍTULOS':
                if($location.path() === $state.get('card-services-conciliacao-conciliacao-titulos').url)
                    controllerAtual = controller;
                controllerCardServicesConciliacaoTitulos = controller;
                return $scope.goCardServicesConciliacaoTitulos; 
            case 'RELATÓRIO DE CONCILIAÇÃO DE TÍTULOS':
                if($location.path() === $state.get('card-services-conciliacao-relatorio-conciliacao-titulos').url)
                    controllerAtual = controller;
                controllerCardServicesRelatorioConciliacaoTitulos = controller;
                return $scope.goCardServicesRelatorioConciliacaoTitulos;
    ...
    var atribuiPermissao = function(controller, controllerpai){
        switch(controller.ds_controller.toUpperCase()){
            ...
            case 'CONSULTA PARÂMETROS' : $scope.PERMISSAO_ADMINISTRATIVO_GESTAO_DE_ACESSOS_CONSULTA_PARAMETROS = true; break;
            ...
            // Notícias
            case 'NOTÍCIAS': $scope.PERMISSAO_NOTICIAS = true; break;
            // Tax Services
            ...
            case 'CONCILIAÇÃO DE TÍTULOS': $scope.PERMISSAO_CARD_SERVICES_CONCILIACAO_CONCILIACAO_TITULOS = true; break;
            case 'RELATÓRIO DE CONCILIAÇÃO DE TÍTULOS': $scope.PERMISSAO_CARD_SERVICES_CONCILIACAO_RELATORIO_CONCILIACAO_TITULOS = true; break;
    ...
    $scope.menuAtivo = function(titulo){//id_controller){
        ...
        switch(titulo.toUpperCase()){//id_controller){
            ...
            // Notícias
            case 'NOTÍCIAS': return state == 'noticias';
            // Card Services
    ...
    $scope.moduloAtivo = function(titulo, titulopai){//id_controller){
        ...
        switch(titulo.toUpperCase()){//id_controller){
            ...
            case 'CONSULTA PARÂMETROS' : return state == 'consulta-parametros';    
            ...
            case 'CONCILIAÇÃO DE TÍTULOS': return state == 'conciliacao-titulos';
            case 'RELATÓRIO DE CONCILIAÇÃO DE TÍTULOS': return state == 'relatorio-conciliacao-titulos';
   ...
   var getElementProgress = function(divPortletBodyPos){
        ...
        var body = $(".portlet-body");//div.children(".portlet-body");
        //console.log(body);
   ...
   /**
     ...
     */
   $scope.getDataFromDate = function(date, filtroapi){
       if(filtroapi)
