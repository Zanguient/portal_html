...
// App
angular.module("card-services-conciliacao-terminal-logico", []) 

.controller("card-services-conciliacao-terminal-logicoCtrl", ['$scope','$state',function($scope,$state){ 
    ...
    $scope.cardServices_conciliacaoTerminalLogicoInit = function(){
        // Título da página 
        $scope.pagina.titulo = 'Card Services';                          
        $scope.pagina.subtitulo = 'Conciliação Terminal Lógico';
